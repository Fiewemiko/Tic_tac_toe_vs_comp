...
def isWinner(bo, le):
    return (
            ...
            or bo[3] == le and bo[9] == le and bo[6] == le
...
def compMove():
    ...
    move = 0  # wtedy kiedy nie ma żadnego ruchu już spełniających below statementy
    for let in ['O', 'X']:
    ...
    if isBoardFull(board):  # przerzuć do komputer move
        print('Tie Game')
